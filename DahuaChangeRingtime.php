<?PHP
$debug = true;
echo "<** Dahua VTH Change Ringtimes **>\n";
$Dahua = new Dahua_Functions("192.168.x.x", "admin", "password"); # VTH's IP and user/pwd
$status = $Dahua->Main();
logging("All done");
...
/*
            "VideoTalkPhoneGeneral": {
                ...
                "TimeLimit": [
                    {
                        ...
                        "MaxLeaveWordTime": 30,
                        "MaxRingingTime": 30   <<<<<====== This is VTH ringing time value
                    },
                    {
                ...
                "VthRingFile": "/mnt/data/Sounds/phoneRing/phone_ring1.mp3",
                "VthRingVolume": 70
            },
*/
    function Main()
